...
/**
 * Persistent class for entity stored in table "commentaire"
 *
...
public class Commentaire implements Serializable, Cloneable {
	...
	// "commentaireTypeId" (column "commentaire_type_id") is not defined by itself because used as FK in a link 

    //----------------------------------------------------------------------
    // ENTITY LINKS ( RELATIONSHIP )
    //----------------------------------------------------------------------
    @ManyToOne
    @JoinColumn(name="commentaire_type_id", referencedColumnName="id")
