...
/**
 * Persistent class for entity stored in table "sous_poste_de_travail"
 *
...
@ToString
@Entity
@Table(name="sous_poste_de_travail" )
public class SousPosteDeTravail implements Serializable, Cloneable {
