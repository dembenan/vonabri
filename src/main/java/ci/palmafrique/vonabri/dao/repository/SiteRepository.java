...
import ci.palmafrique.vonabri.dao.repository.customize._SiteRepository;
...
public interface SiteRepository extends JpaRepository<Site, Integer>, _SiteRepository {
	...
	/**
	 * Finds Site by using code as a search criteria.
	 * 
	 * @param code
	 * @return An Object Site whose code is equals to the given code. If
	 *         no Site is found, this method returns null.
	 */
	@Query("select e from Site e where e.code = :code and e.isDeleted = :isDeleted")
	Site findByCode(@Param("code")String code, @Param("isDeleted")Boolean isDeleted);
	/**
	...
	/**
	 * Finds Site by using deletedBy as a search criteria.
	 * 
	 * @param deletedBy
	 * @return An Object Site whose deletedBy is equals to the given deletedBy. If
	 *         no Site is found, this method returns null.
	 */
	@Query("select e from Site e where e.deletedBy = :deletedBy and e.isDeleted = :isDeleted")
	List<Site> findByDeletedBy(@Param("deletedBy")Integer deletedBy, @Param("isDeleted")Boolean isDeleted);
	/**
