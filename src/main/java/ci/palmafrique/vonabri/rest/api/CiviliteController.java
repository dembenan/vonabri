...
public class CiviliteController {
    ...
    public Response<CiviliteDto> create(@RequestBody Request<CiviliteDto> request) {
    	slf4jLogger.info("start method /civilite/create");
        ...
        try {
        	...
        	if(!response.isHasError()){
               response = civiliteBusiness.create(request, locale);
        	}else{
    ...
    public Response<CiviliteDto> update(@RequestBody Request<CiviliteDto> request) {
		...
		try {
        	...
        	response = Validate.validateList(request, response, functionalError, locale);
        	if(!response.isHasError()){
               response = civiliteBusiness.update(request, locale);
        	}else{
        	   slf4jLogger.info("Erreur| code: {} -  message: {}", response.getStatus().getCode(), response.getStatus().getMessage());
        	   return response;
        	}
    ...
    public Response<CiviliteDto> delete(@RequestBody Request<CiviliteDto> request) {
        ...
        try {
        	...
        	response = Validate.validateList(request, response, functionalError, locale);
        	if(!response.isHasError()){
               response = civiliteBusiness.delete(request, locale);
        	}else{
        	   slf4jLogger.info("Erreur| code: {} -  message: {}", response.getStatus().getCode(), response.getStatus().getMessage());
        	   return response;
        	}
    ...
    public Response<CiviliteDto> getByCriteria(@RequestBody Request<CiviliteDto> request) {
        ...
        try {
        	...
        	if(!response.isHasError()){
               response = civiliteBusiness.getByCriteria(request, locale);
        	}else{
        	   slf4jLogger.info("Erreur| code: {} -  message: {}", response.getStatus().getCode(), response.getStatus().getMessage());
        	   return response;
        	}
		...
		slf4jLogger.info("end method /civilite/getByCriteria");
        return response;
    }
}
