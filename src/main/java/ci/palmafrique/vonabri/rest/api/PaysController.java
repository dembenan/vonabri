...
public class PaysController {
    ...
    public Response<PaysDto> create(@RequestBody Request<PaysDto> request) {
    	slf4jLogger.info("start method /pays/create");
        ...
        try {
        	...
        	if(!response.isHasError()){
               response = paysBusiness.create(request, locale);
        	}else{
    ...
    public Response<PaysDto> update(@RequestBody Request<PaysDto> request) {
		...
		try {
        	...
        	response = Validate.validateList(request, response, functionalError, locale);
        	if(!response.isHasError()){
               response = paysBusiness.update(request, locale);
        	}else{
        	   slf4jLogger.info("Erreur| code: {} -  message: {}", response.getStatus().getCode(), response.getStatus().getMessage());
        	   return response;
        	}
    ...
    public Response<PaysDto> delete(@RequestBody Request<PaysDto> request) {
        ...
        try {
        	...
        	response = Validate.validateList(request, response, functionalError, locale);
        	if(!response.isHasError()){
               response = paysBusiness.delete(request, locale);
        	}else{
        	   slf4jLogger.info("Erreur| code: {} -  message: {}", response.getStatus().getCode(), response.getStatus().getMessage());
        	   return response;
        	}
    ...
    public Response<PaysDto> getByCriteria(@RequestBody Request<PaysDto> request) {
        ...
        try {
        	...
        	if(!response.isHasError()){
               response = paysBusiness.getByCriteria(request, locale);
        	}else{
        	   slf4jLogger.info("Erreur| code: {} -  message: {}", response.getStatus().getCode(), response.getStatus().getMessage());
        	   return response;
        	}
		...
		slf4jLogger.info("end method /pays/getByCriteria");
        return response;
    }
}
