...
public class CiviliteBusiness implements IBasicBusiness<Request<CiviliteDto>, Response<CiviliteDto>> {
	...
	@Override
	public Response<CiviliteDto> create(Request<CiviliteDto> request, Locale locale)  {
		log.info("----begin create Civilite-----");
		
		response = new Response<CiviliteDto>();
		...
		try {
			...
			for (CiviliteDto dto : request.getDatas()) {
				...
				existingEntity = civiliteRepository.findByCode(dto.getCode(), false);
				if (existingEntity != null) {
					response.setStatus(functionalError.DATA_EXIST("civilite code -> " + dto.getCode(), locale));
					response.setHasError(true);
					return response;
				}
	...
	@Transactional(rollbackFor = { RuntimeException.class, Exception.class })
	@Override
	public Response<CiviliteDto> update(Request<CiviliteDto> request, Locale locale)  {
	...
	public Response<CiviliteDto> delete(Request<CiviliteDto> request, Locale locale)  {
		...
		try {
			...
			for (CiviliteDto dto : request.getDatas()) {
				...
				// travailleur
				List<Travailleur> listOfTravailleur = travailleurRepository.findByCiviliteId(existingEntity.getId(), false);
	...
	@SuppressWarnings("unused")
	@Override
	public Response<CiviliteDto> getByCriteria(Request<CiviliteDto> request, Locale locale) {
		...
		try {
			...
			List<Civilite> items = null;
			items = civiliteRepository.getByCriteria(request, em, locale);
